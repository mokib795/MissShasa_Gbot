...
PM_START_TEXT = """
`Hellow` [🤗](https://telegra.ph/file/977804a3688cded6ba673.jpg) `My Name is `*Miss Shasa*
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD Miss SHASA TO YOUR GROUP ➕️", url="http://t.me/MissShasa_bot?startgroup=true"),
    ],
    [
